...
if( ! function_exists( 'newsmatic_current_styles' ) ) :
	...
	function newsmatic_current_styles() {
		...
		ob_start();
			...
			$nBackgroundCode('.newsmatic_main_body nav.main-navigation ul.menu, .newsmatic_main_body nav.main-navigation ul.nav-menu','header_menu_background_color_group');
